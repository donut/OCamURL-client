      ...
      return ReasonReact.element(/* None */0, /* None */0, Curry._3(FetchAliases[/* make */4], query, /* Some */[variables], /* array */[(function (param) {
                          if (typeof param === "number") {
                            ...
                            if (JsOpt$ReactTemplate.notNull(payload.error)) {
                              ...
                              var lst = JsOpt$ReactTemplate.value(payload.aliases);
                              if (lst.length !== 0) {
                                return $$Array.map((function (alias$prime) {
                                              var alias = Alias$ReactTemplate.ofGql(alias$prime);
                                              return ReasonReact.element(/* Some */[alias$prime.id], /* None */0, AliasWidget$ReactTemplate.make(alias, /* array */[]));
                                            }), lst);
                              } else {
                                return React.createElement("div", undefined, "no aliases");
                              }
                            }
                          }
                        })]));
