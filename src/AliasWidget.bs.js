                          ...
                          (function (param) {
                              ...
                              MutateAliasStatus$ReactTemplate.run(name, /* Enable */756818595).then((function (result) {
                                      if (result[0] >= 981919598) {
                                        ...
                                        var exn = result[1];
                                        if (exn[0] === MutateAliasStatus$ReactTemplate.EnableRequest[/* ResponseError */2]) {
                                          var message = exn[2];
                                          Curry._2(reduce, (function () {
                                                  return /* Error */Block.__(1, ["Failed enabling: " + message]);
                                                }), /* () */0);
                                        } else {
                                          console.log("Failed enabling alias [" + (Alias$ReactTemplate.name(alias) + "]."), exn);
                                          Curry._2(reduce, (function () {
                                                  return /* Error */Block.__(1, ["Failed enabling alias. See console."]);
                                                }), /* () */0);
                                        }
                                      }
                                      return Promise.resolve(/* () */0);
                          ...
                          (function (param) {
                              ...
                              MutateAliasStatus$ReactTemplate.run(name, /* Disable */-22441528).then((function (result) {
                                      if (result[0] >= 981919598) {
                                        ...
                                        var exn = result[1];
                                        if (exn[0] === MutateAliasStatus$ReactTemplate.DisableRequest[/* ResponseError */2]) {
                                          var message = exn[2];
                                          Curry._2(reduce, (function () {
                                                  return /* Error */Block.__(1, ["Failed disabling: " + message]);
                                                }), /* () */0);
                                        } else {
                                          console.log("Failed disabling alias [" + (Alias$ReactTemplate.name(alias) + "]."), exn);
                                          Curry._2(reduce, (function () {
                                                  return /* Error */Block.__(1, ["Failed disabling alias. See console."]);
                                                }), /* () */0);
                                        }
                                      }
                                      return Promise.resolve(/* () */0);
