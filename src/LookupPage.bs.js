...
function make(state, dispatch, _) {
  ...
  newrecord[/* render */9] = (function (param) {
      ...
      if (typeof input === "number") {
        details = null;
      } else if (input[0] >= 144245463) {
        details = React.createElement("p", {
              className: "error invalid-input"
            }, "That doesn\'t look like a valid URL: " + (String(input[1]) + ""));
      } else {
        var url = input[1];
        details = React.createElement("div", undefined, ReasonReact.element(/* None */0, /* None */0, GenerateAliasButton$ReactTemplate.make(url, state, /* array */[])), ReasonReact.element(/* None */0, /* None */0, ListAliases$ReactTemplate.make(url, state, dispatch, /* array */[])));
      }
